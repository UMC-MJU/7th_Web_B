...
const GoodMovie = () => {
  const {
    ...
    queryFn: () => useGetMovies({ category: "top_rated", pageParam: 1 }), // 매개변수가 있을 때는 화살표 함수 형식으로 작성해주어야 함.
    queryKey: ["movies", "top_rated"], // 카테고리까지 queryKey값에 넣어주어 다른 페이지에서 받아오는 데이터와 구분시켜줌.
    cacheTime: 10000, // 10초
    staleTime: 10000,
  });
